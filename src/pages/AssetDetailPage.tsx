          ...
          <Grid item xs={12} md={5}>
            <Card>
              ...
              <CardContent>
                ...
                {/* Album Art removed from first column - now displays prominently in Asset Preview section */}

                {/* AI Metadata removed - integrated into description and tags sections for cleaner display */}
