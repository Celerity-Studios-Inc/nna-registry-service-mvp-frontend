    ...
    <Paper sx={{ p: 2, mb: 2 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Typography variant="subtitle1" sx={{ mr: 1 }}>Backend:</Typography>
          ...
          <Chip 
            icon={mockMode ? <WarningAmber fontSize="small" /> : <CheckCircle fontSize="small" />}
      ...
      <Collapse in={expanded}>
        <Box sx={{ mt: 2 }}>
          ...
          <Typography variant="caption" display="block" color="text.secondary">
            When enabled, the application will use mock data instead of real API calls.
            This is useful for testing when the backend is unavailable.
          </Typography>
