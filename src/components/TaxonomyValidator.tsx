  ...
  return (
    <div className="taxonomy-validator">
      ...
      <div className="validator-controls">
        ...
        <div className="control-group">
          <label>MFA:</label>
          <input type="text" value={mfa} readOnly />
        </div>

        <div className="control-group">
          <button onClick={validateLayer}>
            Validate All {layer} Layer Mappings
          </button>
        </div>
      </div>
      ...
      <div className="hfn-mfa-tester">
        ...
        <div className="tester-output">
          <div>
            <strong>HFN:</strong> W.BCH.SUN.001
          </div>
          <div>
            <strong>MFA:</strong>{' '}
            {taxonomyService.convertHFNtoMFA('W.BCH.SUN.001') ||
              'Not available'}
          </div>
          <div>
        ...
        <div className="test-cases-grid">
          {[
            ...
            return (
              <div
                key={index}
                className={`test-case ${isCorrect ? 'passed' : 'failed'}`}
              >
